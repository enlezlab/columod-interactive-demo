...
class PageInteract extends piq {
  ...
  toggleAction() {
    ...
    toggle.addEventListener('click', function () {
      ...
      this.classList.toggle('page-interact__toggle--opened');
    }, false);
  };
  ...
  widgetOpen() {
    ...
    if (window.location.search === '?widget=open') {
      const btnToggle = document.querySelectorAll('.page-interact__toggle')[0];
      btnToggle.click();
    }
  };
  ...
  template() {
    return html`
      <div class="page-interact">
        <a href="https://enlezlab.com/discovery-call" class="btn-exit">
          <span>
          Exit Demo
          </span>
